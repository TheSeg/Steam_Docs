          <section id="GetEvents">
            ...
            <p>I am also proposing retitling these fields to be more professional and useful as descriptions. I have also included a "Online Event" type for live steaming events like <a href="http://www.desertbus.org/" target="_blank">Desert Bus for Hope</a>.</p>
            ...
            <table class="table table-condensed table-bordered table-striped table-hover">
              ...
              <tfoot>
                <tr>
                  <td colspan="4">
                    <i class="icon-asterisk icon-white"></i> Denotes new string.<br>
                    <span class="text-success"><i class="icon-info icon-white"></i> Denotes new field.</span>
                  </td>
                </tr>
              </tfoot>
              <tbody>
                ...
                <tr>
                  ...
                  <td>A lil somethin' different <i class="icon-asterisk icon-white"></i></td>
                </tr>
                <tr>
                  <td>3</td>
                  <td>PartyEvent</td>
                ...
                <tr class="text-success">
                  ...
                  <td>Online Streaming Event <i class="icon-asterisk icon-white"></i> <i class="icon-info icon-white"></i></td>
                </tr>
              </tbody>
            </table>
            ...
            <dl class="dl-horizontal">
              ...
              <dd>The main Events array. Each event returned will have an entry inside this array.</dd>
            </dl>
