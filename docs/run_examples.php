...
print ("<h2>ResolveAppID_01.php</h2>");
print get_include_contents("ISteamHub/examples/ResolveAppID_01.php");
print ("<h2>ResolveAppID_02.php</h2>");
print get_include_contents("ISteamHub/examples/ResolveAppID_02.php");
