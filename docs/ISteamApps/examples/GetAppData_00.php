  ...
  "response" => array(
    ...
    "apps" => array(
      94590 => array(
        ...
        "strings" => array(
            "short_desc" => SteamDocs::htmlText("Agent Nelson Tethers just solved the biggest case of his career. So why isn&#039;t he satisfied? There&rsquo;s still the case of a missing eraser factory foreman, a whispering madness is still creeping from mind to mind, and a troubling recurrence of... creatures... is lurking into the town."),
            "copyright" => SteamDocs::htmlText("&copy; 2011 Telltale Inc. Telltale and the Telltale Games logo are trademarks of Telltale, Inc. Based on the Grickle series of books written and illustrated by Graham Annable. All rights reserved."),
            "about" => SteamDocs::htmlText("<p>Agent Nelson Tethers just solved the biggest case of his career. So why isn&#039;t he satisfied? There&rsquo;s still the case of a missing eraser factory foreman, a whispering madness is still creeping from mind to mind, and a troubling recurrence of... creatures... is lurking into the town.</p>"),
            "key_features" => SteamDocs::htmlText("<ul><li>Sequel to the award winning Puzzle Agent (PC Gamer&rsquo;s Game of the Year, IGN&rsquo;s Best of E3, etc)</li><li>Creepy puzzle adventure with mystery and dark humor</li><li>Wider variety of intuitive yet challenging puzzles</li></ul>\n"),
            "reviews" => null
        ),
        'system_req' => array(
          'windows' => array( 
